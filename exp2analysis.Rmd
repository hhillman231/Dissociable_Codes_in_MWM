---
title: "experiment 2 stats and figures"
...
```{r overall switch effect (paper) }

# interfering movements condition
irr_mvmt_err = data %>%
...
```{r Figure 2B (top) - error (no switch vs switch)}
...
```{r Figure 2B (bottom) - cost (switch - noswitch)}
...
```{r Figure 2C (top) - error (no switch vs switch)}
